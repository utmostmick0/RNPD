...
def Deps(force_reinstall):
    ...
    if not force_reinstall and os.path.exists('/usr/local/lib/python3.9/dist-packages/safetensors'):
        ...
        depsinst('https://github.com/utmostmick0/sd_dependencies/blob/main/rnpddeps.tar.zst'", "/deps/rnpddeps.tar.zst")
...
def sdui(User, Password, model):
    ...
    call('wget -q -O /workspace/sd/stable-diffusion-webui/modules/styles.py https://github.com/TheLastBen/fast-stable-diffusion/raw/main/AUTOMATIC1111_files/styles.py', shell=True)
