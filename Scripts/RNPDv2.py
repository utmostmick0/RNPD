...
def Deps(force_reinstall):
    ...
    if not force_reinstall and os.path.exists('/usr/local/lib/python3.9/dist-packages/safetensors'):
        ...
        depsinst("https://github.com/utmostmick0/sd_dependencies/blob/f2216938549c58f6d16363cdbe8650960839bc7e/rnpddeps-t2.tar.zst", "/deps/rnpddeps-2.tar.zst")
...
def ntbk():
    ...
    call('wget -q -i https://github.com/utmostmick0/RNPD/blob/352718923cdae97f124e3c021d223ec114769f20/Notebooks.txt', shell=True)
