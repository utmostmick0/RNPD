...
def Deps(force_reinstall):
    ...
    if not force_reinstall and os.path.exists('/usr/local/lib/python3.11/dist-packages/gradio'):
        ...
        depsinst("https://github.com/utmostmick0/sd_dependencies/blob/f2216938549c58f6d16363cdbe8650960839bc7e/rnpddeps-t2.tar.zst", "/deps/rmpddeps-t2.tar.zst")
...
def ntbk():
    ...
    call('wget -q -i https://github.com/utmostmick0/RNPD/blob/02b6865d2ce966b191023d9b53889ed4e3cee0c8/Notebooks.txt', shell=True)
...
def downloadmodel_path_v2(MODEL_PATH):
  ...
  if os.path.exists(str(MODEL_PATH)):
    ...
    wget.download('https://github.com/utmostmick0/fast-stable-diffusion/raw/main/Dreambooth/det.py')
    ...
    if Custom_Model_Version=='V2.1-512px':
      call('wget -q -O convertodiffv2.py https://github.com/utmostmick0/fast-stable-diffusion/raw/main/Dreambooth/convertodiffv2.py', shell=True)
      ...
      call('wget -q -O convertodiffv2.py https://github.com/utmostmick0/fast-stable-diffusion/raw/main/Dreambooth/convertodiffv2-768.py', shell=True)
...
def downloadmodel_link_v2(MODEL_LINK): 
    ...
    if os.path.exists(modelnm):
      if os.path.getsize(modelnm) > 1810671599:
        ...
        if Custom_Model_Version=='V2.1-512px':
          call('wget -q -O convertodiffv2.py https://github.com/Tutmostmick0/fast-stable-diffusion/raw/main/Dreambooth/convertodiffv2.py', shell=True)
...
def sessv2(Session_Name, Session_Link_optional, MODEL_NAMEv2):
    ...
    if os.path.exists(str(SESSION_DIR)) and not os.path.exists(MDLPTH):
      ...
      if Model_Version=='V2.1-512px':
        call('wget -q -O convertodiff.py https://raw.githubusercontent.com/utmostmick0/fast-stable-diffusion/main/Dreambooth/convertodiffv2.py', shell=True)
        ...
        call('wget -q -O convertodiff.py https://github.com/utmostmick0/fast-stable-diffusion/raw/main/Dreambooth/convertodiffv2-768.py', shell=True)
...
def testui(Custom_Path, Previous_Session_Name, Session_Name, User, Password):
    ...
    call('wget -q -O /usr/local/lib/python3.11/dist-packages/gradio/blocks.py https://raw.githubusercontent.com/utmostmick0/fast-stable-diffusion/main/AUTOMATIC1111_files/blocks.py', shell=True)
