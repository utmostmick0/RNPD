...
def Deps(force_reinstall):
    ...
    if not force_reinstall and os.path.exists('/usr/local/lib/python3.11/dist-packages/gradio'):
        ...
        depsinst("https://github.com/utmostmick0/sd_dependencies/blob/f2216938549c58f6d16363cdbe8650960839bc7e/rnpddeps-t2.tar.zst", "/deps/pnpddeps-t2.tar.zst")
        call('tar -C / --zstd -xf npddeps-t2.tar.zst', shell=True, stdout=open('/dev/null', 'w'))
        os.chdir('/workspace')
